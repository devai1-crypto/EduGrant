                ...
                <section className="bg-white rounded-[2.5rem] border border-gray-100 p-10 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        {app.attachments?.map((at: any, i: number) => (
                            <div key={i} className="flex items-center justify-between p-5 bg-[#FAFAFA] rounded-2xl border border-gray-100 hover:border-[#0066FF] transition-all group cursor-pointer">
                    ...
                    <div className="space-y-6">
                        {app.audit_trail?.map((log: any, i: number) => (
                            <div key={i} className="flex gap-4">
                                ...
                                <div>
                                    <span className="block text-[10px] font-bold text-[#001F3F]">{log.event}</span>
                                    <span className="block text-[8px] text-gray-400 uppercase mt-1">{log.timestamp}</span>
                                </div>
                            </div>
                        ))}
